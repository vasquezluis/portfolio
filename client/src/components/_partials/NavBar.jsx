  ...
  return (
    <nav className='py-10 mb-12 flex justify-between' id='nav'>
      ...
      <ul className='flex items-center'>
        ...
        <li>
          <a className='bg-jett dark:bg-gradient-to-r from-blue-400 to-blue-700 text-white px-4 py-2 rounded-md ml-4' href='/curriculum.pdf' target='_blank' rel='noopener noreferrer'>Curriculum</a>
        </li>
      </ul>
    </nav>
  )
